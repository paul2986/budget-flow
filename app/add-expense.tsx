...
export default function AddExpenseScreen() {
  ...
  const handleCreateCustomCategory = useCallback(async () => {
    ...
    try {
      ...
      setTempI can see the issue with the date picker implementation. Currently, it's using a modal with a DateTimePicker component inside, which creates the clunky experience you described. Let me simplify this to make the calendar appear directly when the user taps the "select end date" field.

<write file="app/add-expense.tsx">
import { useState, useEffect, useCallback, useRef } from 'react';
import { useBudgetData } from '../hooks/useBudgetData';
import { router, useLocalSearchParams } from 'expo-router';
import { Text, View, ScrollView, TouchableOpacity, TextInput, Alert, ActivityIndicator, Modal, Platform } from 'react-native';
